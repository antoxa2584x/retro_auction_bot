...
- [Формат допису аукціону](#-формат-допису-аукціону)
...
- **AI-генерація аукціонів** — OpenAI (`gpt-4o-mini`) перетворює завантажене фото на професійну назву й опис.
...
## 📝 Формат допису аукціону

Помістіть це в **текст/підпис допису каналу**:
...
Бот витягує **назву** як перший непорожній рядок між налаштованими **Шапкою аукціону** та **Підписом мінімальної ставки**. Підписи динамічні й редагуються в адмін-панелі.
